...
<h2>Fecha</h2>
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Lubricante1" HeaderText="Linea 1" SortExpression="Lubricante1" />
            <asp:BoundField DataField="Lubricante2" HeaderText="Linea 2" SortExpression="Lubricante2" />
            <asp:BoundField DataField="Lubricante3" HeaderText="Linea 3" SortExpression="Lubricante3" />
            <asp:BoundField DataField="Lubricante4" HeaderText="Linea 4" SortExpression="Lubricante4" />
            <asp:BoundField DataField="Lubricante5" HeaderText="Linea 5" SortExpression="Lubricante5" />
            <asp:BoundField DataField="Lubricante6" HeaderText="Linea 6" SortExpression="Lubricante6" />
            <asp:BoundField DataField="Lubricante7" HeaderText="Linea 7" SortExpression="Lubricante7" />
        </Columns>
    </asp:GridView>
