...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gv" runat="server" Width="960" AutoGenerateColumns="False" DataSourceID="dsDatos">
        <Columns>
            ...
            <asp:BoundField DataField="2" HeaderText="2" ReadOnly="True" SortExpression="2" />
            <asp:BoundField DataField="3" HeaderText="3" ReadOnly="True" SortExpression="3" />
            <asp:BoundField DataField="4" HeaderText="4" ReadOnly="True" SortExpression="4" />
            <asp:BoundField DataField="5" HeaderText="5" ReadOnly="True" SortExpression="5" />
            <asp:BoundField DataField="6" HeaderText="6" ReadOnly="True" SortExpression="6" />
            <asp:BoundField DataField="7" HeaderText="7" ReadOnly="True" SortExpression="7" />
            <asp:BoundField DataField="8" HeaderText="8" ReadOnly="True" SortExpression="8" />
            <asp:BoundField DataField="9" HeaderText="9" ReadOnly="True" SortExpression="9" />
            ...
            <asp:BoundField DataField="13" HeaderText="13" ReadOnly="True" SortExpression="13" />
            <asp:BoundField DataField="14" HeaderText="14" ReadOnly="True" SortExpression="14" />
            <asp:BoundField DataField="15" HeaderText="15" ReadOnly="True" SortExpression="15" />
            <asp:BoundField DataField="16" HeaderText="16" ReadOnly="True" SortExpression="16" />
            <asp:BoundField DataField="17" HeaderText="17" ReadOnly="True" SortExpression="17" />
            <asp:BoundField DataField="19" HeaderText="19" ReadOnly="True" SortExpression="19" />
            <asp:BoundField DataField="20" HeaderText="20" ReadOnly="True" SortExpression="20" />
            <asp:BoundField DataField="21" HeaderText="21" ReadOnly="True" SortExpression="21" />
            <asp:BoundField DataField="22" HeaderText="22" ReadOnly="True" SortExpression="22" />
            <asp:BoundField DataField="23" HeaderText="23" ReadOnly="True" SortExpression="23" />
            <asp:BoundField DataField="24" HeaderText="24" ReadOnly="True" SortExpression="24" />
            <asp:BoundField DataField="25" HeaderText="25" ReadOnly="True" SortExpression="25" />
            <asp:BoundField DataField="26" HeaderText="26" ReadOnly="True" SortExpression="26" />
            <asp:BoundField DataField="27" HeaderText="27" ReadOnly="True" SortExpression="27" />
            <asp:BoundField DataField="29" HeaderText="29" ReadOnly="True" SortExpression="29" />
            <asp:BoundField DataField="30" HeaderText="30" ReadOnly="True" SortExpression="30" />
            <asp:BoundField DataField="31" HeaderText="31" ReadOnly="True" SortExpression="31" />
        </Columns>
    </asp:GridView>
    <asp:SqlDataSource ID="dsFechas" runat="server" ConnectionString="<%$ ConnectionStrings:OPCMonitorConnectionString %>"
        SelectCommand="select min(dia) as dia,month(dia)*10000+year(dia) as MesAni from lubricante
